...
signal clicked
signal dropped_on_npc  # Signal emitted when dropped on an NPC
...
var was_held = false  # Track if object was just dropped

func _ready():
	input_pickable = true
	contact_monitor = true  # Enable contact monitoring
	max_contacts_reported = 10  # Increase to detect multiple contacts
